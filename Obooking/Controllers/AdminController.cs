...
using Obooking.DesignPatterns.Startegy;
...
namespace Obooking.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult createBook()
        {
            ...
            Bookkk Stat_pop_mange = new Bookkk();
          

            var statuslist = new List<string> { Stat_pop_mange.performstatusAvaliable() , Stat_pop_mange.performstatusAboutToEnd(), Stat_pop_mange.performstatusUnAvaliable() };
            ViewBag.status = new SelectList(statuslist);

            var popularit = new List<string> { Stat_pop_mange.performspoplrityFamous(), Stat_pop_mange.performspoplrityCommon(), Stat_pop_mange.performspoplrityUnkown() };
